                    ...
                    <div class="auth-card animate-fade-in-up">
                        ...
                        <div class="auth-header text-center">
                            ...
                            <p class="auth-subtitle">
                                Start managing your operations in minutes
                            </p>
                        </div>
                        ...
                        >
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <button
                                        type="button"
                                        class="input-group-text input-icon toggle-pw"
                            ...
                            <button
                                type="submit"
                                class="btn btn-moss w-100 py-2 rounded-pill"
                                :disabled="loading"
                            >
                                <span
                                    v-if="loading"
